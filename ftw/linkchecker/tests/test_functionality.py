...
class TestLinkChecker(FunctionalTestCase):
    ...
    def test_finds_broken_relations(self, browser):
        ...
        # checking_links.create_and_send_mailreport_to_plone_site_responible_person(
        #     email_address_0, broken_relations_and_links, plone_site_objs[0],
        #     total_time_fetching_external)

        # TODO: also test IRichText (adding link into a sl textfield)
